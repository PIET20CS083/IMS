...
class salesClass:
    def __init__(self,root):
        ...
        lbl_invoice=Label(self.root, text="Invioce No.", font=("times new roman", 15), bg="white").place(x=50,y=100)
        ...
        btn_clear=Button(self.root,command=self.clear,text="Clear",font=("times new roman",15,"bold"),bg="lightgrey",cursor="hand2").place(x=490,y=100,width=120,height=28)
        ...
        scrolly2.pack(fill=Y,side=RIGHT)
