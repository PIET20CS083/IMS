...
class employeeClass:
    def __init__(self,root):
        ...
        #    search Frame
        SearchFrame =LabelFrame (self.root, text="Search Employee", font=("goudy old style",12,"bold"),bg="white",relief=RIDGE) 
        ...
        #  title
        title =Label(self.root, text="Employee Details", font=("goudy old style",12,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=100,width=1000) 

        #  content
        #    row1 
        lbl_empid =Label(self.root, text="Emp ID", font=("goudy old style",15,"bold"),bg="white").place(x=50,y=150) 
        lbl_gender =Label(self.root, text="Gender", font=("goudy old style",15,"bold"),bg="white").place(x=350,y=150) 
        lbl_contat =Label(self.root, text="Contact", font=("goudy old style",15,"bold"),bg="white").place(x=750,y=150) 
        ...
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Femlae","Others"),state='readonly',justify=CENTER,font=("goudy old style",15))
        cmb_gender.place(x=500,y=150,width=180)
        cmb_gender.current(0)
        txt_contat =Entry(self.root, textvariable=self.var_contact, font=("goudy old style",15,"bold"),bg="lightyellow").place(x=850,y=150,width=180) 
        #    row2 
        lbl_name =Label(self.root, text="Name", font=("goudy old style",15,"bold"),bg="white").place(x=50,y=190) 
        lbl_dob =Label(self.root, text="D.O.B.", font=("goudy old style",15,"bold"),bg="white").place(x=350,y=190) 
        lbl_doj =Label(self.root, text="D.O.J.", font=("goudy old style",15,"bold"),bg="white").place(x=750,y=190) 
        ...
        #    row3 
        lbl_email =Label(self.root, text="E-Mail", font=("goudy old style",15,"bold"),bg="white").place(x=50,y=230) 
        lbl_pass =Label(self.root, text="Password", font=("goudy old style",15,"bold"),bg="white").place(x=350,y=230) 
        lbl_utype =Label(self.root, text="User Type", font=("goudy old style",15,"bold"),bg="white").place(x=750,y=230) 
        ...
        lbl_salary =Label(self.root, text="Salary", font=("goudy old style",15,"bold"),bg="white").place(x=500,y=270) 
