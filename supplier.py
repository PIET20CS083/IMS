...
class supplierClass:
    def __init__(self,root):
        ...
        #  title
        title =Label(self.root, text="Supplier Details", font=("goudy old style",20,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1030,height=40) 

        #  content
        #    row1 
        lbl_supplier_invoice =Label(self.root, text="Invoice No.", font=("goudy old style",15,"bold"),bg="white").place(x=50,y=80) 
        ...
        #    row2 
        lbl_name =Label(self.root, text="Name", font=("goudy old style",15,"bold"),bg="white").place(x=50,y=120) 
        ...
        #    row3 
        lbl_email =Label(self.root, text="Contact", font=("goudy old style",15,"bold"),bg="white").place(x=50,y=160) 
        txt_email =Entry(self.root, textvariable=self.var_contact, font=("goudy old style",15,"bold"),bg="lightyellow").place(x=180,y=160,width=180) 
       
        #row4
        lbl_desc =Label(self.root, text="Description", font=("goudy old style",15,"bold"),bg="white").place(x=50,y=200) 
