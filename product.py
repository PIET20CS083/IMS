...
class productClass:
    def __init__(self,root):
        ...
        #  title
        title =Label(product_frame, text="Manage Product Details", font=("goudy old style",15,"bold"),bg="#0f4d7d",fg="white").pack(side=TOP,fill=X) 

        #  Column 1
        lbl_category =Label(product_frame, text="Category", font=("goudy old style",15,"bold"),bg="white").place(x=30,y=60) 
        lbl_sup =Label(product_frame, text="Supplier", font=("goudy old style",15,"bold"),bg="white").place(x=30,y=110) 
        lbl_pd_name =Label(product_frame, text="Name", font=("goudy old style",15,"bold"),bg="white").place(x=30,y=160) 
        lbl_price =Label(product_frame, text="Price", font=("goudy old style",15,"bold"),bg="white").place(x=30,y=210) 
        lbl_qunt =Label(product_frame, text="Quantity", font=("goudy old style",15,"bold"),bg="white").place(x=30,y=260) 
